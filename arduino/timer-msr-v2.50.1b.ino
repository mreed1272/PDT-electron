/*================================================================================*
   ...
   Modified 2015 by MSR to newer arduino IDE.
...
/*-----------------------------------------*
  - static definitions -
 *-----------------------------------------*/
#define PDT_VERSION  "2.50.1b"            // software version
#define MAX_LANES    3                 // maximum number of lanes (Uno)
...
#define SMSG_GCLOS    'C'             // -> gate closed
